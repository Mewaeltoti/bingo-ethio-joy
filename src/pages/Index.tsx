    ...
    <PageShell>
      ...
      <div className="text-center pt-8 pb-6">
        ...
        >
          ...
          <p className="text-muted-foreground mt-2 text-sm">Play. Win. Celebrate.</p>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="gradient-card rounded-2xl border border-border p-5 glow-gold mb-6"
      >
      ...
      <div className="mt-8 space-y-3">
        <h2 className="font-display text-sm font-semibold text-muted-foreground uppercase tracking-wider">How it works</h2>
        {[
          { step: '1', text: 'Deposit funds to your wallet' },
          { step: '2', text: 'Buy a cartela for 20 ETB' },
          { step: '3', text: 'Wait for the game to start' },
          { step: '4', text: 'Match the pattern & win!' },
        ].map(({ step, text }) => (
          <div key={step} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
            <div className="w-8 h-8 rounded-full gradient-gold flex items-center justify-center font-display font-bold text-primary-foreground text-sm">
              {step}
            </div>
